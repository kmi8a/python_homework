...
class Board():
    ...
    def __init__(self):
        self.board_array = [[' ' for x in range(3)] for x in range(3)]
        self.turn = "X"
        self.last_move = None
...
b = Board()
print('\nWelcome to Tic-Tac-Toe, use the following commands to move:')
print('\nupper left, upper center, upper right, middle left, center, middle right, lower left, lower center, lower right.\n')

while not b.whats_next()[0]:
    player_move = input(f"{b.turn}'s turn: ").lower()
    try:
        b.move(player_move)
